    ...
    <header className="z-[999] relative">
                  ...
                  <li key={link.hash}>
                    <Link
                      ...
                      onClick={() => {
                        ...
                        setOpen(false); // Close the menu after a link is clicked
                      }}
                    >
                      {link.name}
                    </Link>
      ...
      <div className="hidden sm:block">
        ...
        <nav className="flex fixed top-[0.15rem] left-1/2 -translate-x-1/2 py-2 sm:top-[1.7rem] sm:py-0">
          <ul className="flex w-full flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:flex-nowrap sm:gap-5">
            {translatedLinks.map((link) => (
              <motion.li
